			...
			<header id='services' className='mx-auto flex w-full max-w-7xl flex-col items-center gap-10 md:gap-16'>
				...
				<div  className='flex w-full flex-col items-center gap-8 lg:flex-row lg:items-stretch'>
					...
					<div className='flex w-full flex-1 flex-col gap-4 text-start'>
						<ServicesCard imgSrc={noteIcon} title="Accounting & Bookkeeping" desc="Keep your finances organized with accurate recordkeeping, monthly reconciliations, and clear financial reporting so you always know where your business stands." />
						<ServicesCard imgSrc={planningIcon} title="Tax & Planning" desc="Plan ahead with strategic tax guidance, accurate filings, and year-round support designed to help you minimize surprises and stay compliant." />
						<ServicesCard imgSrc={advisoryIcon} title="Business Advisory" desc="Make smarter business decisions with practical financial insights, cash flow guidance, and growth-focused advice tailored to your goals." />
						<ServicesCard imgSrc={taxIcon} title="Payroll & Sales Tax Services" desc="Simplify payroll, remittances, and sales tax filings with reliable support that keeps your business running smoothly and on schedule." />
					</div>
				</div>
			</header>
		</section>
